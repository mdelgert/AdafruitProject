...
void setup() {
  ...
  pixels.setPixelColor(1-12, 0xFFFFFF);  // make white
...
//https://github.com/ernesto-xload/phukdlib_leonardo/blob/master/phukdlib_leonardo.cpp
/********************************************************************
